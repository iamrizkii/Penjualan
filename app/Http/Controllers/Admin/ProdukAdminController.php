...
class ProdukAdminController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('produk.index')->with('success', 'Berhasil Memperbaharui Produk');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('produk.index')->with('delete', 'Berhasil Menghapus Produk');
    }
    ...
    {
        $produk = Produk::withTrashed()->find($id);
        $produk->restore();
    ...
    public function forceDelete($id)
    {
        ...
        return redirect()->route('produk.trash')->with('delete', 'Produk berhasil dihapus permanen.');
    }
}
