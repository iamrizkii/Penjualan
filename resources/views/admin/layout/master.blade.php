...
<body data-layout="horizontal" class="">
    ...
    <footer class="footer text-center text-sm-start">
        ...
        </script> Metrica | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>dapurkita.com</a>
        <span class="text-muted d-none d-sm-inline-block float-end">Crafted with <i
                class="mdi mdi-heart text-danger"></i> by Dapur Kita</span>
    </footer>
    <!-- end Footer -->
    <!--end footer-->
