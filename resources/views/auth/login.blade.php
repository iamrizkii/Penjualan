                            ...
                            <div class="card mb-0 border-0">
                                <div class="card-body p-0">
                                    <div class="text-center p-3">
                                        ...
                                        <h4 class="mt-3 mb-1 fw-semibold font-18">Selamat Datang Di Dapur Kita</h4>
                                        <br>
                                        <center>
                                            <p>Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>dapurkita.com</a></p>
                                        </center>
                                    </div>
                                </div>
                                <!--end card-body-->
