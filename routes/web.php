...
Route::middleware(['auth', 'user-access:admin'])->group(function () {
    ...
    Route::get('produk/trash', [ProdukAdminController::class, 'trash'])->name('produk.trash');
    Route::get('produk/restore/{id}', [ProdukAdminController::class, 'restore'])->name('produk.restore');
    Route::post('produk/force-delete/{id}', [ProdukAdminController::class, 'forceDelete'])->name('produk.force-delete');
